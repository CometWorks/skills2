...
:: 17. Optionally build the Graphify graph for the decompiled game code. The Graphify
...
if exist "%~dp0..\se2-dev\GraphifyPrepare.bat" (
    call "%~dp0..\se2-dev\GraphifyPrepare.bat" "se2-dev-game-code" "%GAME_CODE_GRAPH_ROOT%"
) else (
